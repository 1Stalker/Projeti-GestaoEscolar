...
<head>
    ...
    <title>Pagamento de Taxas</title>
    <style type="text/css">
      .payment{
        margin-bottom: 10%;
      }
...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">FACULDADE META</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="check-fee-recipt.php">recibo de taxa</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" href="index.php">Voltar para a página principal</a>
        </li>
        <li class="nav-item">
      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Informações de pagamento</h3>
  ...
  <option value="12c">Class 12 (Commerce)</option>
                  ...
                  <select class="instal" aria-label="Default select example" id="instalment">
                      <option selected>Selecione a parcela</option>
                      <option value="i1">Prestação 1 (Abril)</option>
                      <option value="i2">Prestação 2 (Julho)</option>
                      <option value="i3">Prestação 3 (Outubro)</option>
                      <option value="i4">Prestação 4 (Janeiro)</option>
                      <option value="bus">Taxa de ônibus</option>
              ...
              style="margin-top: 8%;">Digitalize para pagar</button>
