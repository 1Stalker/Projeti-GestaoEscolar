...
<body>
    <header>
        ...
        <div class="navbar">
            ...
            <a href="exam.php">
                <span class="material-icons-sharp">visualização em grade</span>
                <h3>Exame</h3>
            </a>
