...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="images/logometa_icone.png">
</head>
...
<body>
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="images/frente_meta.jpg" alt="">
        <div class="text">
          <span class="text-1">Faculdade<br></span>
          <span class="text-2">Gestão administrativa</span>
        </div>
      </div>
        ...
        <div class="login-form">
          ...
          <form action="index.php" id="login-form" method="post">
            <div class="input-boxes">
              ...
              <div class="text"><a id="forgotpassword">Esqueceu sua senha?</a></div>
          ...
          <form action="index.php" id="forgotPassword-form" method="post" style="display:none;">
            ...
            <div class="input-boxes">
              ...
              <div class="text" style="margin-bottom: 20px;display:flex">
                <a id="backToLogin">voltar para o login?</a>
              </div>
          ...
          <form id="otpVarification-form" method="post" style="display:none;">
            ...
            <div class="input-boxes">
              ...
              <div class="text" style="margin-bottom: 20px;display:flex">
                <a id="backToforgotPasswordForm">voltar</a>
                <a id="resendOTP" style='margin-left: auto;'>reenviar formulario?</a>
              </div>
          ...
          <form id="createNewPassword-form" method="post" style="display:none;">
            ...
            <div class="input-boxes">
              ...
              Nova senha e confirmação de senha não são a mesma coisa!
              </div>
