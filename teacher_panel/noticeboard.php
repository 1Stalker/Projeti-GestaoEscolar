...
<div class="modal" style="z-index: 2000;" id="edit-notice" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Editar Avisos</h1>
                <button type="button" class="close mr-2" data-bs-dismiss="modal" aria-label="Close"><i
                        class='bx bx-x'></i></button>
            </div>
                    ...
                    <div class="m-3">
                        <div class="noticeform">
                            <div class="mb-3">
                                ...
                                Você precisa adicionar o Título!
                                </div>
                            </div>


                            <div class="mb-3">
                                <label for="body" class="form-label">Aviso
                                </label>
                                <textarea class="form-control" id="edit-notice-body" name="body" rows="5"></textarea>
                                <div class="invalid-feedback" id="edit-invalid-body">
                                É necessário o texto de Aviso ou Qualquer arquivo!
                                </div>
                            </div>


                            <div class="mb-3">
                                <label for="file" class="form-label">Qualquer arquivo</label><br>
                                ...
                                O arquivo é muito grande, o limite permitido é 200 MB!
                                </div>
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">Importância</label>
...
<div class="modal fade" id="delete-confirmation-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>Você realmente deseja excluir este Aviso?</strong>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                <button type="button" class="btn btn-danger" onclick="deleteNotice()">Excluir</button>
            </div>
        </div>
    </div>
</div>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active " id="createNoticeTab" data-bs-toggle="tab" data-bs-target="#home"
                            type="button" role="tab" aria-controls="home" aria-selected="true">Criar
                            Aviso</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="show-notice-tab" data-bs-toggle="tab" data-bs-target="#profile"
                            type="button" role="tab" aria-controls="profile" aria-selected="false">Aviso
                            Quadro</button>
                    </li>
                            ...
                            <form class="needs-validation" id="notice-form" novalidate>
                                    ...
                                    <div class="noticeform">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="invalid-feedback" id="invalid-body">
                                               É necessário texto de Aviso ou qualquer arquivo!
                                            </div>
                                        </div>

                                        <br>
                                        <div class="mb-3">
                                            <label for="file" class="form-label">Qualquer arquivo</label>
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <button type="button" class="btn btn-outline-warning" id="reset-notice"
                                        onclick="cleanForm()">&nbsp;&nbsp;Reiniciar&nbsp;&nbsp;</button>
                                    <button type="button" class="btn btn-outline-success" id="post-notice">Publicar</button>
                                </div>
                            </form>
                                ...
                                <div class="attendenceTable" style="display: block;">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" class="btn btn-light" id="prevBtn">anterior</button>
                                            <a class="btn btn-secondary disabled" role="button" aria-disabled="true"
                                                id="pageNumber">1</a>
                                            <button type="button" class="btn btn-light" id="nextBtn">próximo</button>
                                        </div>
                                    </div>
