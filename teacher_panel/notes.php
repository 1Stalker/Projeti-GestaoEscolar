            ...
            <form class="needs-validation" id="uploadNotesForm" novalidate>
                ...
                <div class="modal-body">
                    <div class="container my-3">
                        ...
                        <div class="mb-2">
                            <label for="formFile" class="form-label">Carregar arquivo &nbsp; <small>(tamanho máximo
                            200MB)</small></label>
...
<div class="modal fade" id="delete-confirmation-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>Você realmente deseja excluir essas notas?</strong>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title fs-5" id="exampleModalLabel">Editar notas enviadas</h1>
                <button type="button" class="close mr-2" data-bs-dismiss="modal" aria-label="Close"><i
                        class='bx bx-x'></i></button>
            </div>
                        ...
                        <div class="showAttendence">
                            ...
                            <div class="container" style="display: flex;">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-auto">
                                        <label for="inputPassword6" class="col-form-label">Disciplina </label>
                                    </div>
                                    <div class="col-auto">
