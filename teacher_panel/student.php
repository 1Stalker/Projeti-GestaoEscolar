    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>Você realmente deseja editar os detalhes do aluno?</strong>
            </div>
...
<div class="modal fade" id="delete-confirmation-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>Você realmente quer excluir o Aluno?</strong>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                <button type="button" class="btn btn-danger" onclick="deleteTeacherWithIdSeted()">Excluir</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal" style="z-index: 2000;" id="addTeacherModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Detalhes do aluno</h1>
            ...
            <form class="needs-validation" id="general-form" novalidate>
                    ...
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="section" class="form-label">Turma</label>
                                    <select class="form-select" id="section" name="section" style="width:100%;"
                                        required>
                                        <option selected disabled value="">--selecionar--</option>
                                        <option value="A">121</option>
                                        <option value="B">122</option>
                                        <option value="C">123</option>
                                    </select>
                                    <div class="invalid-feedback">
                                    obrigatório!
                                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="general-info-btn">
                        <div><i class='bx bxs-chevrons-right'></i><span> próximo</span></div>
                    </button>
                </div>
            </form>
...
<div class="modal" style="z-index: 2000;" id="personalInformationModal" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Detalhes do endereço</h1>
                <button type="button" class="close mr-2" data-bs-dismiss="modal" aria-label="Close"><i
                        class='bx bx-x'></i></button>
            </div>
            <form class="needs-validation" id="personal-form" novalidate>
                    ...
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="state" name="state"
                                required>
                                <option selected disabled value="">--selecionar--</option>
                                <option value="Hariyana">Amapá</option>
                                <option value="UP">UP</option>
                                <option value="Delhi">Macapá</option>
                                <option value="Panjab">Santana</option>
                                <option value="Gujrat">Porto grande</option>
                            </select>
                            <div class="invalid-feedback">
                            obrigatório!
                            </div>
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" onclick="backToStudentDetail()">
                        <div><i class='bx bxs-chevrons-left'></i><span>Voltar</span></div>
                    </button>
...
<div class="modal" style="z-index: 2000;" id="guardian_information" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Detalhes de contato de emergência</h1>
                <button type="button" class="close mr-2" data-bs-dismiss="modal" aria-label="Close"><i
                        class='bx bx-x'></i></button>
            </div>
            <form class="needs-validation" id="guradian-form" novalidate>
                <div class="modal-body">
                    ...
                    <div class="container my-3">
                        <div class="mb-3">
                            <label for="guardian" class="form-label">Nome do guardião</label>
                        ...
                        <div class="mb-3">
                            <label for="gphone" class="form-label">Número de telefone</label>
                        ...
                        <div class="mb-3">
                            <label for="gaddress" class="form-label">Endereço</label>
                        ...
                        <div class="mb-3">
                            <label for="city-info" class="form-label">Cidade</label>
                            <div class="row">
                                <div class="col">
                        ...
                        <div class="mb-3">
                            <label for="relation" class="form-label">Relacionamento com o aluno</label>
...
<div class="modal removeTeacherModal" style="z-index: 2000;" id="removeStudentModel" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title text-danger fs-5" id="exampleModalLabel">Excluir aluno</h1>
                <button type="button" class="close mr-2" data-bs-dismiss="modal" aria-label="Close"><i
                        class='bx bx-x'></i></button>
            </div>
            <form class="needs-validation" id="remove-student-form" novalidate>
                <div class="modal-body">
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            <label for="student-id" class="form-label">Matrícula do Estudante</label>
                            <input type="text" class="form-control remove_student_id" id="student-id" aria-describedby="" required>
                            <div class="invalid-feedback">
                            Forneça uma matrícula de estudante válida.
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="remove-student-btn">
                        <div><span>Excluir aluno</span></div>
                    </button>
                </div>
            </form>
        </div>
            ...
            <div class="orders">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item me-1" role="presentation">
                        <button class="nav-link active " id="addStudentTab" data-bs-toggle="tab" data-bs-target="#home" onclick="AddStudentBtnClick()" type="button" role="tab" aria-controls="home" aria-selected="true">Adicionar alunos</button>
                    </li>
                    <li class="nav-item me-1" role="presentation">
                        <button class="nav-link" id="view-students-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false" onclick="showStudents()">Mostrar
                        Alunos</button>
                    </li>
                    <li class="nav-item me-1" role="presentation">
                            ...
                            <div class="header">
                                ...
                                <div class="student-btns">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item reset-attendence" id="add_student_dropdown" data-bs-toggle="modal" data-bs-target="#addTeacherModal">Adicionar aluno</a></li>
                                        <li><a class="dropdown-item submit-attendence" id="remove_student_dropdown" data-bs-toggle="modal" data-bs-target="#removeStudentModel">Remover aluno</a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                        <div class="showAttendence">
                            ...
                            <div class="container" style="display: flex;">
                                <div class="row g-3 align-items-center">
                                    <div class="col-auto">
                                        <label for="inputPassword6" class="col-form-label">Seção </label>
                                    </div>
                                    <div class="col-auto">
                                        <select class="form-select" aria-label="Default select example"
                                            id="search-section">
                            ...
                            <div class="container">
                                        ...
                                        <table class="remove-cursor-pointer">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" class="thead col-2">Matrícula do Aluno</th>
                                                    <th scope="col" class="thead col-5">Nome</th>
                                                    <th scope="col" class="thead col-3">Ação</th>
                                                </tr>
                                            </thead>
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-secondary" id="prev-page-btn">anterior</button>
                                        <a class="btn btn-secondary disabled" role="button" aria-disabled="true"
                                            id="page-number">1</a>
                                        <button type="button" class="btn btn-secondary" id="next-page-btn">próximo</button>
                                    </div>
                                </div>
