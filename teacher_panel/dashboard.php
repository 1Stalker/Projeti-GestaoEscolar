    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Adicionar lembrete</h1>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary text-center _flex-container" onclick="addReminder()"> <i
                        class='bx bx-plus'></i>&nbsp;<strong>ADICIONAR</strong></button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="bottom-data">
            <div class="orders">
                <div class="header">
                    ...
                    <h3 id="text-heading">Últimos Avisos</h3>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>14-08-2023</td>
                            <td><span class="status complain">Reclamar</span></td>
                        </tr>
                        <tr>
                            <td class="user">
                            ...
                            <td>14-08-2023</td>
                            <td><span class="status notice">Evento</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
