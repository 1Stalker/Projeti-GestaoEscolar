                ...
                <table class="remove-cursor-pointer">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="thead col-3">ID do professor</th>
                            <th scope="col" class="thead col-5">Nome</th>
                            <th class="thead col-2">Ação</th>
                        </tr>
                    </thead>
                ...
                <table class="table table-stripped">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col">Avançar</th>
                            <th scope="col">Pagar</th>
                        </tr>
                    </thead>
                    <tbody class="no-hover">
                        <tr>
                            <td class="p-1 m-0">Janeiro</td>
                            <td class="p-1 m-0">
