                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active " id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                            type="button" role="tab" aria-controls="home" aria-selected="true">Fazer a chamada</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link showAttendenceBtn" id="profile-tab" data-bs-toggle="tab"
                            data-bs-target="#profile" type="button" role="tab" aria-controls="profile"
                            aria-selected="false">Comparecimento por data</button>
                    </li>
                            ...
                            <div class="header">
                                ...
                                <div class="dropdown dropdown-center">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item reset-attendence">Redefinir frequência</a></li>
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <a class="btn btn-secondary disabled" role="button" aria-disabled="true"
                                            id="pageCount">1</a>
                                        <button type="button" class="btn btn-secondary" id="nextBtn">próximo</button>
                                    </div>
                                </div>
