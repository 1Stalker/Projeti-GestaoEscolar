    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Resultado do upload</h1>
            ...
            <form class="needs-validation" id="create-exam-form" novalidate>
                <div class="modal-body">
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            <label for="title" class="form-label">Título do exame</label>
                            ...
                            Por favor, escolha um título de exame.
                            </div>
                        </div>
                        ...
                        <div class="row mb-3" style="">
                            <div class="col-md-6">
                                ...
                                Por favor, escolha uma classe de exame.
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                Selecione um assunto para o exame.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3" style="">
                            <div class="col-md-6">
                                <label for="total" class="form-label">Total de notas</label>
                                ...
                                Total de notas inválido!
                                </div>
                            </div>

                            <div class="col-md-6">
                                <label for="passing" class="form-label">Notas de aprovação</label>
                                ...
                                Notas de aprovação inválidas!
                                </div>
                            </div>

                            <div class="invalid-feedback passingGreaterTotalError">
                            As notas de aprovação devem ser menores que as notas totais!
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="continue-btn">
                        <div><i class='bx bxs-chevrons-right'></i><span>Continuar</span></div>
                    </button>
                </div>
                                            ...
                                            <table class="remove-cursor-pointer remove_hover_table">
                                                <thead id="UploadTableHead">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="thead col-4">Nome</th>
                                                        <th scope="col" class="thead col-2">Total notas</th>
                                                        <th scope="col" class="thead col-2">Notas obtidas </th>
                                                    </tr>
                                                </thead>
