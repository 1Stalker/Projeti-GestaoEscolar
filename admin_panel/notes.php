    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Carregar notas</h1>
            ...
            <form class="needs-validation" id="uploadNotesForm" novalidate>
                ...
                <div class="modal-body">
                    <div class="container my-3">
                        ...
                        <div class="row" style="">
                            ...
                            <div class="col-md-7">
                                <label for="subjectList" class="form-label">Assunto</label>
                        ...
                        <div class="mb-2">
                            <label for="formFile" class="form-label">Carregar arquivo &nbsp; <small>(max-size
                                    200MB)</small></label>
                            <input class="form-control" type="file" id="formFile" name="file"
                                accept=".pdf, .png, .doc, .jpg, .jpeg, .zip, .tar, .gz" required>
                            <div id="wrong-comment" class="invalid-feedback file-size-error">
                            O arquivo é muito grande, o limite permitido é de 200 MB!
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="uploadNotes">
                        <div><i class='bx bxs-cloud-upload'></i>&nbsp;&nbsp;<span> Carregar</span></div>
                    </button>
                </div>
...
<div class="modal fade" id="edit-confirmation-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>Você realmente deseja editar esta nota?</strong>
...
<div class="modal fade" id="delete-confirmation-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>Você realmente deseja excluir esta nota?</strong>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                <button type="button" class="btn btn-danger" onclick="deleteNote()">Excluir</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-warning view-result-btn" target="_blank" id="view_file_btn">
                    <i class='bx bx-show-alt'></i> &nbsp;&nbsp;<span>Visualizar</span>
                </a>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title fs-5" id="exampleModalLabel">Editar notas carregadas</h1>
                <button type="button" class="close mr-2" data-bs-dismiss="modal" aria-label="Close"><i
                        class='bx bx-x'></i></button>
            </div>
            ...
            <form class="needs-validation" id="editNotesForm" novalidate>
                ...
                <div class="modal-body pb-0">
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Comentáriost</label>
                ...
                <div class="modal-footer pt-0">
                    ...
                    <button type="button" class="btn btn-primary" id="editNote">
                        <div><i class='bx bxs-cloud-upload'></i>&nbsp;&nbsp;<span> Editar</span></div>
                    </button>
                </div>
                        ...
                        <div class="showAttendence">
                            ...
                            <div class="container" style="display: flex;">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-auto">
                                        <label for="inputPassword6" class="col-form-label">Fechar </label>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a class="btn btn-secondary disabled" role="button" aria-disabled="true"
                                        id="pageNumber">1</a>
                                    <button type="button" class="btn btn-light" id="nextBtn">proximo</button>
                                </div>
                            </div>
                        </div>
                    </div>
